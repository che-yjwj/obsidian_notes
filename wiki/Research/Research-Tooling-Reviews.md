...
- This page is a curated deep dive for reviewed research tooling artifacts.
- It interprets PaperDebugger and PaperBanana as tools/papers, not as the canonical home for research workflow policy.
- Agent execution rules and collaboration operating model stay in [[wiki/Research/AI-Assisted-Research-Workflow]].

## Boundary

This page should focus on:
- reviewed tooling artifacts and what they automate
- debugging, visualization, and artifact-production implications
- why those tools matter for system builders and research practice

This page should not become the main home for:
- end-to-end workflow policy
- agent role ownership rules
- research operating procedures across the vault

Those belong in [[wiki/Research/AI-Assisted-Research-Workflow]].
...
이 둘은 reasoning 이론보다 연구자의 생산성 도구를 직접 겨냥한다.

- PaperDebugger는 실험과 구현의 정합성 검증 도구에 가깝다
- PaperBanana는 결과 표현과 논문 생산 보조 도구에 가깝다
- 둘 다 [[wiki/Research/AI-Assisted-Research-Workflow]]와 연결되지만, 이 페이지의 초점은 operating policy가 아니라 reviewed tooling artifact 해석이다
